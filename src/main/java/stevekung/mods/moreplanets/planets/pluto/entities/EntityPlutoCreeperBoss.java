...
public class EntityPlutoCreeperBoss extends EntityDionaCreeperBoss
{
    public EntityPlutoCreeperBoss(World world)
    {
        super(world);
    ...
    public EntityPlutoCreeperBoss(World world, Vector3 vec)
    {
        this(world);
    ...
    {
        return new ItemStack(MPItems.spawn_egg_mp, 1, 1044);
    }
    ...
    protected void onDeathUpdate()
    {
        ...
        if (this.deathTicks == 200 && !this.worldObj.isRemote)
        {
            ...
            {
                if (tile instanceof TileEntityPlutoTreasureChest)
                {
                    ...
                    TileEntityPlutoTreasureChest chest = (TileEntityPlutoTreasureChest) tile;

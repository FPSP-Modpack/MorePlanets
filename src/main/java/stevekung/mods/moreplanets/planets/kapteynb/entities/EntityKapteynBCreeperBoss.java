...
public class EntityKapteynBCreeperBoss extends EntityDionaCreeperBoss
{
    public EntityKapteynBCreeperBoss(World world)
    {
        super(world);
    ...
    public EntityKapteynBCreeperBoss(World world, Vector3 vec)
    {
        this(world);
    ...
    {
        return new ItemStack(MPItems.spawn_egg_mp, 1, 1043);
    }
    ...
    protected void onDeathUpdate()
    {
        ...
        if (this.deathTicks == 200 && !this.worldObj.isRemote)
        {
            ...
            {
                if (tile instanceof TileEntityKapteynBTreasureChest)
                {
                    ...
                    TileEntityKapteynBTreasureChest chest = (TileEntityKapteynBTreasureChest) tile;
            ...
            this.entityDropItem(new ItemStack(KapteynBItems.kapteyn_b_dungeon_key, 1, 0), 0.5F);
            super.setDead();
